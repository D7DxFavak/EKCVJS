 ...
 */
@Embeddable
public class PrihlFakturyRozpisyPK implements Serializable {
    ...
    public PrihlFakturyRozpisyPK() {
    }

    public PrihlFakturyRozpisyPK(int polozkaPrihl, int cisloFaktury) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrihlFakturyRozpisyPK)) {
            return false;
        }
        PrihlFakturyRozpisyPK other = (PrihlFakturyRozpisyPK) object;
    ...
    public String toString() {
        return "entity.PrihlFakturyRozpisyPK[ polozkaPrihl=" + polozkaPrihl + ", cisloFaktury=" + cisloFaktury + " ]";
    }
