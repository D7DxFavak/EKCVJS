 ...
 */
@Embeddable
public class AkrOblzarJemnePK implements Serializable {
    ...
    public AkrOblzarJemnePK() {
    }

    public AkrOblzarJemnePK(int oblzarHrubeId, int oblzarJemneId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AkrOblzarJemnePK)) {
            return false;
        }
        AkrOblzarJemnePK other = (AkrOblzarJemnePK) object;
    ...
    public String toString() {
        return "entity.AkrOblzarJemnePK[ oblzarHrubeId=" + oblzarHrubeId + ", oblzarJemneId=" + oblzarJemneId + " ]";
    }
