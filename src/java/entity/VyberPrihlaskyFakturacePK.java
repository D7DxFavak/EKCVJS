 ...
 */
@Embeddable
public class VyberPrihlaskyFakturacePK implements Serializable {
    ...
    public VyberPrihlaskyFakturacePK() {
    }

    public VyberPrihlaskyFakturacePK(int prihlPolozka, int druhprihl, int faktDruh) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VyberPrihlaskyFakturacePK)) {
            return false;
        }
        VyberPrihlaskyFakturacePK other = (VyberPrihlaskyFakturacePK) object;
    ...
    public String toString() {
        return "entity.VyberPrihlaskyFakturacePK[ prihlPolozka=" + prihlPolozka + ", druhprihl=" + druhprihl + ", faktDruh=" + faktDruh + " ]";
    }
