...
import session.PrihlaskyRozpisyFacade;
import session.PrihlaskyRozpisyJsFacade;
import session.UzivateleFacade;
import session.WebOrgOsFacade;
...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        Uzivatele uzR = null;
        if (hRequest.getAttribute("typKlient") == null) {
            if (hRequest.getRemoteUser() != null) {
                uzR = uzivatelPrihlaseni.findPodleJmena(hRequest.getRemoteUser());
                if (uzR.getUzivateleOrganizaceId() != null) {
                    hRequest.setAttribute("typKlient", 2); //2 - pro organizaci 
                    hRequest.setAttribute("klient", uzR.getUzivateleOrganizaceId());
                    ...
                    hRequest.setAttribute("typKlient", 1); //1 - pro osobu
                    hRequest.setAttribute("klient", uzR.getUzivateleOsobyId());
                    ...
                    hRequest.setAttribute("typKlient", 0); //0 - pro nic
                }
            } else {
                hRequest.setAttribute("typKlient", 0); //0 - pro nic
            }
