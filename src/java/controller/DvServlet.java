 ...
 * @author Favak
 */
@WebServlet(name = "DvServlet", loadOnStartup = 2,
urlPatterns = {"/dvpp"})
public class DvServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        zt.setIdKategorieZakladni(40);
        request.setAttribute("kategorieZakladniPopis", "dvpp");
        ...
        if (odkazNazev != null) {
            ...
            if (odkazNazev.equals("aktuality.jsp")) {
                if (!zt.getAktualniStranka().equals("dvpp?aktuality.jsp")) {
                    zt.vycistit("dvpp?aktuality.jsp");
                }
                ...
                if (!zt.getAktualniStranka().equals("dvpp?galerie.jsp")) {
                    zt.vycistit("dvpp?galerie.jsp");
                }
                ...
                if (!zt.getAktualniStranka().equals("dvpp?galerieDetail.jsp")) {
                    zt.vycistit("dvpp?galerieDetail.jsp");
                }
                ...
                if (!zt.getAktualniStranka().equals("dvpp?keStazeni.jsp")) {
                    zt.vycistit("dvpp?keStazeni.jsp");
                ...
                request.setAttribute("selectedCenter", "WEB-INF/dvpp/" + odkazNazev);
                ...
                if (!zt.getAktualniStranka().equals("dvpp?kontakty.jsp")) {
                    zt.vycistit("dvpp?kontakty.jsp");
                    zt.setIdOsOzHruba(zt.getIdKategorieZakladni());
                }
                ...
                kontaktyOsOzHrube.add(webOsOblzarHrubeFacade.findById(zt.getIdKategorieZakladni()));
             ...
             * (!zt.getAktualniStranka().equals("dvpp?vseobecnepodminky.jsp")) {
             * zt.vycistit("dvpp?vseobecnepodminky.jsp"); } WebPanely wp =
             ...
             * "WEB-INF/dvpp/vseobecnepodminky.jsp"); } else if
             * (odkazNazev.equals("dvpp.jsp")) { if
             * (!zt.getAktualniStranka().equals("dvpp?dvpp.jsp")) {
             * zt.vycistit("dvpp?dvpp.jsp"); } WebPanely wp =
             * panelyFacade.findByOdkazKategorie(odkazNazev,
             * kategorieFacade.findById(zt.getIdKategorieZakladni()));
             * Collection<WebPanelyData> panelyData =
             * webPanelyDataFacade.findByStranka(wp);
             ...
             */ else {
                if ((odkazNazev.contains("ulozisteData") == false) && (odkazNazev.contains("galerieUvodni") == false)
                    ...
                    if (!zt.getAktualniStranka().equals("dvpp?" + odkazNazev)) {
                        zt.vycistit("dvpp?" + odkazNazev);
                    }
                    WebPanely wp = panelyFacade.findByOdkazKategorie(odkazNazev, kategorieFacade.findById(zt.getIdKategorieZakladni()));
                    Collection<WebPanelyData> panelyData = webPanelyDataFacade.findByStranka(wp);                  
                    request.setAttribute("panelNazev", wp.getWebPanelyNazev());
