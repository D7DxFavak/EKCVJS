        ...
        <ul>
            ...
            <%--<li class="topListItemNektivni">
                <a href="dvpp?dvpp.jsp">
                    <span class="categoryLabelTextNektivni">${zobrazeniTabulek.webProp.nazev("dvpp")}</span>                   
                </a>
                <ul>
            ...
            <li class="topListItemAktivni">
                <a href="dvppvpk?dvppvpk.jsp">                
                    <span class="categoryLabelTextAktivni">${zobrazeniTabulek.webProp.nazev("dvppvpk")}</span>                   
                </a>
                <ul>
...
<div id="container40">
    ...
    <div id="panelLeftColumn">
        ...
        <div id="leftColumnUl2">  
            <ul>
                <c:forEach var="panely" items="${panelyDvppvpkData}">     
                    <c:choose>
                        <c:when test="${panely.webPanelyOdkaz eq 'forum.jsp'}">
                            <li onclick="location.href = 'http://kcvjs.cz/forum';"> 
                        ...
                        <c:otherwise>
                            <li onclick="location.href = 'dvppvpk?${panely.webPanelyOdkaz}';">  
                                <a href="dvppvpk?${panely.webPanelyOdkaz}" class="panelButton">
                                    <img src="img/mbuttarr.png" alt="mbutar">
                                    <span class="panelText">
                                        ${zobrazeniTabulek.webProp.nazev(panely.webPanelyNazev)}
                                    </span>
    ...
    <c:choose>
        <c:when test="${selectedCenter eq 'WEB-INF/dvppvpk/vzdProgramy.jsp'}">
                ...
                <div id="wrapperCenter">
                    <c:choose>       
                        <c:when test="${selectedCenter == null}">
                            <jsp:include page="WEB-INF/dvppvpk/zakladniInfo.jsp"/>
                        </c:when>
                        <c:otherwise>
                            <jsp:include page="${selectedCenter}"/>
                        </c:otherwise>
    ...
    <c:if test= "${selectedCenter ne 'WEB-INF/dvppvpk/vzdProgramy.jsp'}">
