        ...
        <ul>
            ...
            <li class="topListItemAktivni">
                <a href="ucitele?ucitele.jsp">
                    <span class="categoryLabelTextAktivni">${zobrazeniTabulek.webProp.nazev("ucitele")}</span>                   
                </a>
                <ul>
...
<div id="container20">
    ...
    <%-- <div id="panelLeftColumn">
        ...
        <div id="leftColumnUl2">
            <ul>
                <c:forEach var="panely" items="${panelyUciteleData}">     
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li onclick="location.href = 'ucitele?${panely.webPanelyOdkaz}';">  
                                <a href="ucitele?${panely.webPanelyOdkaz}" class="panelButton">
                                    <img src="img/mbuttarr.png" alt="mbutar">
                                    <span class="panelText">
                                        ${zobrazeniTabulek.webProp.nazev(panely.webPanelyNazev)}
                                    </span>
    ...
    <c:choose>
        <c:when test="${selectedCenter eq 'WEB-INF/ucitele/vzdProgramy.jsp'}">
                ...
                <div id="wrapperCenter">
                    <c:choose>       
                        <c:when test="${selectedCenter == null}">
                            <jsp:include page="WEB-INF/ucitele/zakladniInfo.jsp"/>
                        </c:when>
                        <c:otherwise>
                            <jsp:include page="${selectedCenter}"/>
                        </c:otherwise>
