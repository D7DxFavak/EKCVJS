    ...
    <div id="indexTopColumnC1">
        <ul>
            ...
            <li class="topListItemAktivni">
                <a href="js?js.jsp">
                    <span class="categoryLabelTextAktivni">${zobrazeniTabulek.webProp.nazev("js")}</span>                   
                </a>
                <ul>
            ...
            <ul>
                <c:forEach var="panely" items="${panelyJsData}">     
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li onclick="location.href = 'js?${panely.webPanelyOdkaz}';">  
