        ...
        <div id="wrapperPrihlaskyContainer">
            ...
            <div id ="navigace">
                <div id="zobrZaznam">
                    ...
                    <a class="navClass" href="ekcvjs?vypisDokumentuOs.jsp&pocetStrana=10">10</a>
                    <a class="navClass" href="ekcvjs?vypisDokumentuOs.jsp&pocetStrana=20">20</a>
                    <a class="navClass" href="ekcvjs?vypisDokumentuOs.jsp&pocetStrana=50">50</a>             
                </div>
                <div id="strana">
                    <c:forEach var="strana" items="${strany}" varStatus="iter">
                        <c:choose>
                            <c:when test="${strana.cislo == -1}">
                                <a class="navClass" href="ekcvjs?vypisDokumentuOs.jsp&offset=${strana.cislo}">${strana.retez}</a>
                            </c:when>
