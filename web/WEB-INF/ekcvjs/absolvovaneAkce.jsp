...
<html>
    ...
    <body> 
          <div class="wrapperPrihlaskyNadpis">
            <p>...${zobrazeniTabulek.webProp.nazev("absolvovane_akce")}</p>
        </div>
        <div id="wrapper">
                        ...
                        <c:forEach var="strana" items="${strany}" varStatus="iter">
                            <c:choose>
                                <c:when test="${strana.cislo == -1}">
                                    <a class="navClass" href="ekcvjs?absolvovaneAkce.jsp&offset=${strana.cislo}">${strana.retez}</a>
                                </c:when>
                        ...
                        <c:forEach var="akce" items="${prihlaskyAkce}" varStatus="iter">
                            <li class="itemSeznamKurzu">
                                <div class="kurzCisloAkce">
                                    <a href="ekcvjs?absolvovaneAkce.jsp&akceIdDetail=${akce.akceId}">
                                ...
                                <div class="kurzNazevTerminAkce">
                                    <a href="ekcvjs?absolvovaneAkce.jsp&akceIdDetail=${akce.akceId}">${akce.nazev}</a>
           ...
           <%-- <div id="navigaceTop">
                <ul class="navigaceList">
                    <li> 
                        <a href="ekcvjs?absolvovaneAkce.jsp">
                            <span class="navigacePopis">${zobrazeniTabulek.webProp.nazev("absolvovane_akce")}</span>                                
                        </a></li>
                    <li>
                        <div class="slash">></div>
                    </li>    
                                        ...
                                        <div id="divPrihlaseniShop">                                       
                                            ...
                                            <ul class="tabPrihlaseniShop">
                                                <c:forEach var="osoba" items="${prihlaseneOsoby}" varStatus="iter">
                                                    <li>
                                                        <a href="ekcvjs?detailyOsoby.jsp&detailOsobaId=${osoba.osobaId}">
                                                            ${osoba.titulPred} ${osoba.jmeno} ${osoba.prijmeni} ${osoba.titulZa}${not iter.last ? ',&nbsp ' : '&nbsp '} 
                                                        </a>                                      
                                                    </li>
                                                </c:forEach>
                                            </ul>
            ...
            <div id ="navigace">
                <p>${zobrazeniTabulek.webProp.nazev("tab_zobrazit_zaznamu")} :</p>               
                <a class="navClass" href="ekcvjs?absolvovaneAkce.jsp&pocetStrana=10">10</a>
                <a class="navClass" href="ekcvjs?absolvovaneAkce.jsp&pocetStrana=20">20</a>
                <a class="navClass" href="ekcvjs?absolvovaneAkce.jsp&pocetStrana=50">50</a>             
            </div>
            <div id="strana">
                <c:forEach var="strana" items="${strany}" varStatus="iter">
                    <c:choose>
