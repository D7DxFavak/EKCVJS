    ...
    <body>    
        <div id="wrapperPrihlaskyContainer">
            ...
            <div id="NazevAkce">            
                ...
                <form action="filtrAkceDvpp" method="post" id="hledatFormAkce">
            ...
            <div id="Obory">
                ...
                <select name="vyberObor" size="1" onchange="document.location.href='dvpp?vzdProgramy.jsp&idObor='+this.value">
            ...
            <div id="obdobi">
                ...
                <select name="vyberObdobi" size="1" onchange="document.location.href='dvpp?vzdProgramy.jsp&idObdobi='+this.value">
            ...
            <div id="tableHeaderAkce">
                ...
                <div id ="headerCisloAkce">
                    <a href="dvpp?vzdProgramy.jsp&sort=0">                
                        <c:choose>
                ...
                <div id="headerNazevAkce">
                    <a href="dvpp?vzdProgramy.jsp&sort=1">        
                        <c:choose>
                ...
                <div id="headerTerminAkce">
                    <a href="dvpp?vzdProgramy.jsp&sort=2">         
                        <c:choose>
                ...
                <div id="headerCenaAkce">
                    <a href="dvpp?vzdProgramy.jsp&sort=3">                
                        <c:choose>
                    ...
                    <tr class="${((iter.index % 2) == 0) ? 'lightBlue' : 'white'}">
                        ...
                        <c:choose>
                            <c:when test = "${zobrazeniTabulek.idAkce == akce.akceId}">
                                ...
                                <td width="90">
                                    <a href="dvpp?vzdProgramy.jsp&akceIdDetail=${akce.akceId}">
                                ...
                                <td width="370">
                                    <div id="divNazev">
                                        <a href="dvpp?vzdProgramy.jsp&akceIdDetail=${akce.akceId}">${akce.nazev}</a>
                                    </div>                            
                                </td>
                                <td width="140">
                                    ${akce.terminObecny}
                                ...
                                <td width="115">
                                    ...
                                    <form action="<c:url value='pridatDoKosiku'/>" method="post">
                                        <input type="hidden"
                                               ...
                                               value="${akce.akceId}">
                                        <input type="hidden"
                                               name="odkazStranaLogin"
                                               value="dvpp?vzdProgramy.jsp">
                                        <c:if test="${akce.volno == true}">
                                            <div>
                                                <input type="submit"
                                                       name="submit"
            ...
            <div id ="navigace">
                ...
                <a class="navClass" href="dvpp?vzdProgramy.jsp&pocetStrana=10">10</a>
                <a class="navClass" href="dvpp?vzdProgramy.jsp&pocetStrana=20">20</a>
                <a class="navClass" href="dvpp?vzdProgramy.jsp&pocetStrana=50">50</a>             
            </div>
            <div id="strana">
                <c:forEach var="strana" items="${strany}" varStatus="iter">
                    <c:choose>
                        <c:when test="${strana.cislo == -1}">
                            <a class="navClass" href="dvpp?vzdProgramy.jsp&offset=${strana.cislo}">${strana.retez}</a>
                        </c:when>
