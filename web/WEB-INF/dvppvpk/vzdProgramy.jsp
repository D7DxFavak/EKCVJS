...
<%--<c:set var="view" value="/ucitele" scope='session' />--%>
        ...
        <div id="wrapperPrihlaskyContainer">
           <%-- <div id="navigaceTop">
                <ul class="navigaceList">
                    ...
                    <li> 
                        <a href="dvppvpk?vzdProgramy.jsp">
                            <span class="navigacePopis">${zobrazeniTabulek.webProp.nazev("dvppvpk")}</span>                                
                        </a>
                    </li> 
                </ul>
            </div>--%>
            <div id="NazevAkce">            
                ...
                <form action="filtrAkcedvppvpk" method="post" id="hledatFormAkce">
                    <input type="text" name="filtrNazevAkce"
                           value="${zobrazeniTabulek.hledanaAkce}"
                           class="inp_text" onfocus=
                               "javascript:{if (this.value == '${zobrazeniTabulek.webProp.nazev("hledany_vyraz")}') this.value='';}"
            ...
            <div id="Obory">
                ...
                <select name="vyberObor" size="1" onchange="document.location.href='dvppvpk?vzdProgramy.jsp&idObor='+this.value">
            ...
            <div id="obdobi">
                ...
                <select name="vyberObdobi" size="1" onchange="document.location.href='dvppvpk?vzdProgramy.jsp&idObdobi='+this.value">
            ...
            <div id="tableHeaderAkce">
                <div id ="headerVolnoAkce">
                    <a href="dvppvpk?vzdProgramy.jsp&sort=5">                
                      
                    </a>
                </div>
                <div id ="headerCisloAkce">
                    <a href="dvppvpk?vzdProgramy.jsp&sort=0">                
                        <c:choose>
                ...
                <div id="headerNazevAkce">
                    <a href="dvppvpk?vzdProgramy.jsp&sort=1">        
                        <c:choose>
                ...
                <div id="headerTerminAkce">
                    <a href="dvppvpk?vzdProgramy.jsp&sort=2">         
                        <c:choose>
                ...
                <div id="headerCenaAkce">
                    <a href="dvppvpk?vzdProgramy.jsp&sort=3">                
                        <c:choose>
                    ...
                    <tr class="${((iter.index % 2) == 0) ? 'lightBlue' : 'white'}">
                        ...
                        <c:choose>
                            <c:when test = "${zobrazeniTabulek.idAkce == akce.akceId}">
                                ...
                                <td width="90">
                                    <a href="dvppvpk?vzdProgramy.jsp&akceIdDetail=${akce.akceId}">
                                ...
                                <td width="370">
                                    <div id="divNazev">
                                        <a href="dvppvpk?vzdProgramy.jsp&akceIdDetail=${akce.akceId}">${akce.nazev}</a>
                                    </div>                            
                                </td>
                                <td width="140">
                                    ${akce.terminObecny}
            ...
            <div id ="navigace">
                ...
                <a class="navClass" href="dvppvpk?vzdProgramy.jsp&pocetStrana=10">10</a>
                <a class="navClass" href="dvppvpk?vzdProgramy.jsp&pocetStrana=20">20</a>
                <a class="navClass" href="dvppvpk?vzdProgramy.jsp&pocetStrana=50">50</a>             
            </div>
            <div id="strana">
                <c:forEach var="strana" items="${strany}" varStatus="iter">
                    <c:choose>
                        <c:when test="${strana.cislo == -1}">
                            <a class="navClass" href="dvppvpk?vzdProgramy.jsp&offset=${strana.cislo}">${strana.retez}</a>
                        </c:when>
