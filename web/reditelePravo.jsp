        ...
        <div id="wrapperContainer">
            ...
            <div id="tableHeaderDokumenty">
                <div id ="headerDokumentyNazev">
                    <a href="${kategorieZakladniPopis}?reditelePravo.jsp&sort=0">           
                        <p>${zobrazeniTabulek.webProp.nazev("dokument_nazev")}</p>
                       
                    </a>
                </div>
                <div id ="headerDokumentDatumVlozeni">
                    <a href="${kategorieZakladniPopis}?reditelePravo.jsp&sort=1">      
                ...
                <div id="headerDokumentPopis">                
                    <a href="${kategorieZakladniPopis}?reditelePravo.jsp&sort=2"> 
                        <p>${zobrazeniTabulek.webProp.nazev("dokument_popis")}</p>
                    </a>
                </div>
                <div id="headerDokumentStahnout">
                    <a href="${kategorieZakladniPopis}?reditelePravo.jsp&sort=3">
                    ...
                    <tr class="${((iter.index % 2) == 0) ? 'lightBlue' : 'white'}">     
                        <c:choose>
                            <c:when test = "${zobrazeniTabulek.idUloziste == dokument.ulozisteData.ulozisteDataId}">
                                ...
                                <td width="80">
                                    <a href="${kategorieZakladniPopis}?reditelePravo.jsp&ulozisteDataId=${dokument.ulozisteData.ulozisteDataId}">${zobrazeniTabulek.webProp.nazev("data_popis")}</a>                               
                                </td>
                                <td width="90">                        
            ...
            <div id ="navigace">
                ...
                <a class="navClass" href="${kategorieZakladniPopis}?reditelePravo.jsp&pocetStrana=10">10</a>
                <a class="navClass" href="${kategorieZakladniPopis}?reditelePravo.jsp&pocetStrana=20">20</a>
                <a class="navClass" href="${kategorieZakladniPopis}?reditelePravo.jsp&pocetStrana=50">50</a>             
            </div>
            <div id="strana">
                <c:forEach var="strana" items="${strany}" varStatus="iter">
                    <c:choose>
                        <c:when test="${strana.cislo == -1}">
                            <a class="navClass" href="${kategorieZakladniPopis}?reditelePravo.jsp&offset=${strana.cislo}">${strana.retez}</a>
                        </c:when>
